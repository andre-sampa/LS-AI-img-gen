...
def prompt_gen(adventurer_id, scene_dropdown):
    ...
    if scene_dropdown == "Adventurer Portait":
        ...
        prompt = f"A battle between a medieval, fantasy adventurer, and a massive {beast_last_battle}, deep within the confines of a dark, foreboding dungeon. The adventurer is {equipment_sentence}. The equipment are strictly medieval, crafted from materials and techniques possible in that era. The adventurer is attacking using his {weapon_equipment} and powerful magic, the glow of his spells or the glint of his weapon illuminate the stone walls. The {beast_last_battle} stands in a dark undergroud dungeon. Its eyes glow faintly in the dark. It roars menacingly, surrounded by broken weapons and bones of his past preys. The dungeon is dimly lit by flickering torches, their light casting long, ominous shadows across the ancient, cracked floor. Unreal Engine render style, photorealistic, realistic fantasy style."
        ...
        if adventurer_health != 0:
            ...
            prompt = f"Close-up shot of a dramatic battle between a medieval fantasy adventurer and a massive {beast_last_battle} deep within the confines of a dark, foreboding dungeon. The {beast_last_battle} has emerged victorious, taking his final attack over the fallen adventurer. The adventurer lies defeated, {equipment_sentence}. His equipment are strictly medieval, crafted from materials and techniques possible in that era. The scene takes place in a dark underground dungeon, dimly lit by flickering torches. The {beast_last_battle}'s eyes glow faintly in the dark, casting an eerie light. The dungeon walls are damp and covered in moss, with ancient runes carved into the stone. Unreal Engine render style, photorealistic, realistic fantasy style, highly detailed, cinematic lighting, and atmospheric effects."
    else:       
        pass
